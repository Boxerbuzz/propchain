...
export function WithdrawalInput() {
  ...
  const grouped = useMemo(() => {
    return SAMPLE_DATA.mentionable.reduce((acc, item) => {
            ...
            <DropdownMenu open={scopeMenuOpen} onOpenChange={setScopeMenuOpen}>
              ...
              >
                ...
                <DropdownMenuGroup>
                  ...
                  >
                    <label htmlFor="apps">
                      <SquareHalfBottomIcon /> Apps and Integrations
                      <Switch id="apps" className="ml-auto" defaultChecked />
                    </label>
                  </DropdownMenuItem>
                  <DropdownMenuItem>
                    <CircleDashedIcon /> All Sources I can access
                  </DropdownMenuItem>
                  <DropdownMenuSub>
                    <DropdownMenuSubTrigger>
                      <Avatar className="size-4">

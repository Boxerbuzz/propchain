...
import { Loader2, Wallet, Building2, Coins, ArrowRight, Info, ArrowLeft } from "lucide-react";
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enter the amount and select your withdrawal method</CardDescription>
            </CardHeader>
